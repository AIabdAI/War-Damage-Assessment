...
## Central analysis — Plan A vs Plan B (validation estimates)

> **Note:** this section reasons from *validation* numbers and predates the
> held-out test evaluation. The [test-split section](#test-split-results-held-out-evaluated-once)
> below carries the final measured numbers and the final verdict
> (which updates the recommended detector to yolo26m).
...
**Verdict on validation evidence: Plan A — yolo12m-det11 detection + Swin-Tiny damage
